...
class RoomSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('rooms')->insert([
            ['name' => '201-1A-A17', 'num_of_equip' => 86, 'created_at' => now(), 'updated_at' => now()],
            ['name' => '202-1A-A17', 'num_of_equip' => 86, 'created_at' => now(), 'updated_at' => now()],
            ['name' => '301-1A-A17', 'num_of_equip' => 86, 'created_at' => now(), 'updated_at' => now()],
            ['name' => '302-1A-A17', 'num_of_equip' => 86, 'created_at' => now(), 'updated_at' => now()],
            ['name' => '303-1A-A17', 'num_of_equip' => 86, 'created_at' => now(), 'updated_at' => now()],
