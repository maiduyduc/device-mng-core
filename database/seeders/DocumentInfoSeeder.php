...
class DocumentInfoSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('document_infos')->insert([
            ...
            ['document_id' => 1, 'category_id' => 2,'device_name' => 'Hạt mạng RJ45', 'device_info' => 'Hạt mạng RJ45','origin' => 'VN', 'unit' => 'Hộp', 'order_qty' => 2, 'stock' => 0 , 'recommended_qty' => 2, 'unit_price' => 1000, 'total_money' => 100000, 'note' => 'Đi dây mạng phòng thực hành mới', 'created_at' => now(), 'updated_at' => now()],
            ['document_id' => 1, 'category_id' => 4,'device_name' => 'Giấy A4', 'device_info' => 'Giấy A4','origin' => 'VN', 'unit' => 'Ram', 'order_qty' => 1, 'stock' => 0 , 'recommended_qty' => 1, 'unit_price' => 1200000, 'total_money' => 36000000, 'note' => '', 'created_at' => now(), 'updated_at' => now()],
