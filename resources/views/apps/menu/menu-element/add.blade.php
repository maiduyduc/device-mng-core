        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Tạo menu con mới</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Quản lý menu con</a></li>
                            <li class="breadcrumb-item active">Tạo menu con mới</li>
                        </ol>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <form method="post" action="{{ route('menu.store') }}">
                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <a href="{{ route('menu.index') }}" class="btn btn-danger w-md col-md-5">Hủy</a>
                                </div>
                            </form>
                            <div class="col-lg-6">
                            </div>
