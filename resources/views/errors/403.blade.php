...
<head>
    ...
    <meta content="Mai Duy Duc" name="author">
    <!-- App favicon -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    ...
                    <h4 class="text-uppercase">Bạn không có quyền truy cập trang web này!</h4>
                    <div class="mt-5 text-center">
                        <a class="btn btn-primary waves-effect waves-light" href="/">Trang chủ</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-8 col-xl-6">
                <div>
                    <img src="{{ asset('assets\apps\assets\images\error-img.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
